      ...
      <main className="pt-24 lg:pt-28 pb-16">
        <div className="container-main">
          ...
          <div className="max-w-3xl mx-auto text-center mb-8">
            <p className="text-primary font-medium mb-4">You're Almost There!</p>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">Unlock Your Results</h1>
            <p className="text-lg text-muted-foreground max-w-xl mx-auto">
              Enter your details below to see your personalized Leak Report and recommendations.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <iframe
              ...
              title="Unlock Your Results Form"
            />
          </div>
