    ...
    >
      ...
      <defs>
        ...
        <linearGradient id="verticalLineGradient" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor={getColorWithOpacity(1)} />
          <stop offset="100%" stopColor={getColorWithOpacity(0)} />
        </linearGradient>
      </defs>
      ...
      {/* Vertical line from dot down — lives in SVG so it's always aligned with the dot */}
      <motion.line
        x1={middlePoint.x}
        y1={middlePoint.y}
        x2={middlePoint.x}
...
export function NumberFlowCounter({
  ...
  return (
    <div
      ...
      } transition-opacity duration-300 ease-in-out absolute top-32 left-[42%] -translate-x-1/2 text-sm bg-[#1A1B25] border border-white/[0.07] text-white px-4 py-1 rounded-full h-8 flex items-center justify-center gap-0.5 font-mono shadow-[0px_1.1px_0px_0px_rgba(255,255,255,0.20)_inset,0px_4.4px_6.6px_0px_rgba(255,255,255,0.01)_inset,0px_2.2px_6.6px_0px_rgba(18,43,105,0.04),0px_1.1px_2.2px_0px_rgba(18,43,105,0.08),0px_0px_0px_1.1px_rgba(18,43,105,0.08)]`}
    >
