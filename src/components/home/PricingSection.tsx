...
const tiers = [{
  ...
  features: ["Ads management + basic funnel", "CRM pipeline setup", "SMS/email follow-up sequences", "Basic reporting dashboard", "Email & chat support"],
  popular: false
}, {
  name: "Professional",
  label: "For clinics ready to scale bookings",
  features: ["Everything in Starter", "AI voice qualification", "Live transfer to your team", "Reactivation campaigns", "Weekly optimization calls", "Priority support"],
  popular: true
}, {
  name: "Enterprise",
  label: "For multi-location or high-volume clinics",
  features: ["Everything in Professional", "Multi-location support", "Custom integrations", "Dedicated account manager", "Advanced analytics & insights", "HIPAA-ready workflows"],
  popular: false
}];
  ...
  return <section className="section-spacing relative overflow-hidden">
      ...
      <div className="container-main relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {tiers.map((tier, index) => <div key={index} className={`relative card-premium p-6 lg:p-8 flex flex-col ${tier.popular ? "border-primary/50 ring-1 ring-primary/20" : ""}`}>
              {/* Popular badge */}
              ...
              {/* CTA */}
              <a href="https://calendly.com/locusops" target="_blank" rel="noopener noreferrer" className={`block text-center py-3 rounded-xl font-semibold transition-all duration-300 mb-6 ${tier.popular ? "btn-primary" : "btn-secondary"}`}>
                Schedule a call
              </a>
              ...
              <div className="space-y-3 flex-1">
                ...
                {tier.features.map((feature, fIndex) => <div key={fIndex} className="flex items-start gap-3">
