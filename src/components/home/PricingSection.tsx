...
const tiers = [
  ...
  {
    name: "Locus Command",
    tagline: "Revenue Operations Partner",
    positioning: "Multi-location visibility. Ongoing optimization. Embedded accountability.",
    features: [
      "Everything in Locus Ops",
      "Multi-location command center dashboard",
      "Custom tech stack integrations (EMR/EHR)",
      "Embedded revenue operations partnership",
