import { ClockSpeedIcon, RefreshLoopIcon, LeadSignalIcon, CalendarSlotIcon, ShieldIcon } from "@/components/icons/BrandIcons";
      ...
      <div className="container-main relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            You're paying for attention you can't convert. Slow response, missed calls, after-hours gaps, staff overload, and inconsistent follow-up are bleeding your ad budget dry.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {leakItems.map((item, index) => (
            <div
              key={index}
              className="card-premium-hover p-6 group"
            >
